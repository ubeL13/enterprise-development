...
public interface IRentalService
{
    ...
    /// </summary>
    public Task<RentalDto?> GetByIdAsync(string id);

    /// <summary>
    /// Creates a new rental.
    /// </summary>
    public Task<RentalDto> CreateAsync(RentalCreateDto dto);

    /// <summary>
    /// Updates an existing rental.
    /// </summary>
    public Task<RentalDto?> UpdateAsync(RentalUpdateDto dto);
